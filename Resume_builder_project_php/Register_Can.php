   ...
   if($_SERVER['REQUEST_METHOD']=="POST")
	{
        ...
        $result=$con->query("select *from Register_can where c_uname = '$c_uname'");
            ...
            {
                echo '<script>alert("User Already Exits Enter UNIQUE Name ...!")</script>';
            ...
            else
            {
                ...
                if(preg_match('/^[0-9]{10}+$/', $c_phoneno))
                {
					
                    $result=$con->prepare("INSERT INTO register_can(c_name,c_uname,c_gender,c_dob,c_email,c_phoneno,c_address,c_city,c_zip,c_college_name,c_insititue_name,c_qualification,c_department,c_skills)
                    VALUES('$c_name','$c_uname','$c_gender','$c_dob','$c_email',
                    '$c_phoneno','$c_address','$c_city','$c_zip','$c_college_name','$c_insititute_name','$c_qualification','$c_department','$c_skills')");
                    $cnt= $result->execute();
					
					if($cnt==1)
					{
                        echo '<script>alert("From Has Been Submit SucessFully...!")</script>';                   
					}
					
					else
					{
						echo '<script>alert("From Has Been Not Submit SucessFully...!")</script>';  
					}
			 } 
                ...
                <div class="form-wrapper">
                    <form method="POST">
                        ...
                        <div class="form-item">
                            ...
                            <input type="text" name="c_uname" placeholder="Create Your User Name" >
                        </div>
                        ...
                        <div class="form-item">
                            <label>E-mail:</label>
                            <input type="text" name="c_email" placeholder="email@xyz.com" required>
                        </div>
                        <div class="form-item">
